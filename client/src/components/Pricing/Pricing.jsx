...
//       }));
//     } else {
//       this.setState({ sourceAddress: this.pickupAddress.value });
//     }
//   };
...
//     let addressObject = this.autocomplete_.getPlace();
//     if (addressObject !== undefined) {
//       let destLat = addressObject.geometry.location.lat() || 0;
//       let destLng = addressObject.geometry.location.lng() || 0;
//       this.setState((prevState) => ({
//         ...prevState,
//         destination: { lat: +destLat, lng: +destLng },
//         centerDest: { lat: +destLat, lng: +destLng },
//         destinationAddress: addressObject && addressObject.formatted_address,
//       }));
//     } else {
//       this.setState({ destinationAddress: this.destinationAddress.value });
//     }
//   };
...
//       .then((res) => {
//         this.setState({
//           estimate: res.data.data,
//           minPrice: res.data.data.min,
//           maxPrice: res.data.data.max,
//           loading: false,
//         });
...
//     return (
//       <>
//         <SEO title="UZI Logistics and  | Pricing" />
//         <div>
//           <TheHeader
//             bgColor="light-blue"
//             kobo={logocolored}
...
//                 dest={this.state.destination}
//                 center={this.state.center}
//                 centerDest={this.state.centerDest}
//                 sourceAddress={this.state.sourceAddress}
//                 onChange={this.onChange}
//                 tonnage={this.state.tonnage}
//                 destAddress={this.state.destinationAddress}
